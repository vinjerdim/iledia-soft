...
/* ============================================================
   app-stage-inti.js — Tahap 4-6 (PBL fase 3: penyelidikan)
     4. telusur      menandai calon entitas & atribut pada temuan lapangan
     5. saring       mengelompokkan atribut ke entitasnya
     6. klasifikasi  memilah atribut kunci/biasa & menyaring usulan
   ============================================================ */
...
function renderTelusur(container) {
  ...
  /* Kebutuhan sah adalah token berkind 'entitas' atau 'atribut';
     kind lain (fungsi, lain) adalah pengecoh yang dapat ditandai
     murid, tapi tidak dihitung menuju minTemuan. */
  function isKebutuhan(t) {
    return t.kind === 'entitas' || t.kind === 'atribut';
  }
...
/* ============================================================
   TAHAP 5 — Kelompokkan atribut ke entitasnya
   ============================================================ */
  ...
  if (st.checked && !semuaBenar) {
    ...
    rincian = explainList(
      salah.map(function (c) {
        var tujuan = findById(d.entities, c.entityId);
        return {
          right: false,
