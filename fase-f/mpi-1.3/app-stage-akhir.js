...
function renderSelesai(container) {
  ...
  var labelSkor = {
    ...
    bekal: 'Bekal konsep',
    saring: 'Kelompokkan ke entitas',
    klasifikasi: 'Klasifikasi atribut kunci',
    sajikan: 'Uji identifikasi entitas & atribut',
  ...
  container.innerHTML =
    ...
    entityCards(DATA.saring.entities, DATA.saring.chips, DATA.sajikan.keyBadge) +
    '</div>' +
