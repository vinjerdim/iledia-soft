...
/* ============================================================
   app.js — perakitan materi 1.3  (DIMUAT PALING AKHIR)
   ============================================================
...
var STAGE_DEFS = [
  ...
  { id: 'saring', label: 'Kelompokkan ke Entitas', render: 'renderSaring' },
  { id: 'klasifikasi', label: 'Klasifikasi Atribut', render: 'renderKlasifikasi' },
...
var lesson = Engine.createLesson({
  ...
  createState: function () {
    return {
      ...
      /* Tahap 5 — Kelompokkan ke entitas */
      saring: {
        assignments: {},
        selectedId: null,
        checked: false,
...
assertUniqueIds(DATA.saring.entities, 'saring.entities');
