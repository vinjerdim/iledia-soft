...
function renderBekal(container) {
  ...
  /* Kartu konsep TIDAK diacak: ini konten pengantar, bukan pilihan
  ...
  var istilah = orderItems(skey('bekal', 'match', 'terms'), d.terms);
  var pengertian = orderItems(skey('bekal', 'match', 'defs'), d.defs);
      ...
      ? '<div class="panel">' +
        ...
        (m.checked
          ? feedbackBox(
              ...
              benarSemua ? '✓' : '!',
              benarSemua
                ? '<strong>Semua pasangan tepat.</strong> Bekalmu siap dipakai menelusuri petunjuk lapangan.'
