...
function renderRefleksi(container) {
  ...
  /* Mengingat kembali tebakan saat menguji identifikasi. Tebakan boleh
     saja kosong (mis. progres lama), jadi jangan berasumsi ada isinya. */
...
function renderSelesai(container) {
  ...
  var labelSkor = {
    ...
    bekal: 'Bekal konsep',
    saring: 'Saring jenis relasi',
    klasifikasi: 'Klasifikasi FK & tabel penghubung',
    sajikan: 'Uji identifikasi relasi',
  ...
  container.innerHTML =
    ...
    '<div class="panel">' +
    '<h3>' + esc(d.entitasLabel) + '</h3>' +
    entityCards(DATA.entitas.list, DATA.entitas.attrs, 'Atribut Kunci') +
    '</div>' +

    '<div class="panel">' +
    '<h3>' + esc(d.relasiLabel) + '</h3>' +
    miniTable(DATA.sajikan.tableHeaders, relasiRows()) +
    '</div>' +
